...
// Shared entry-action icons (Heroicons outline). Used by the entry cards in the
// day feed and the four tracker log pages (food/sleep/mood/weight) so the edit
// and delete affordances stay visually consistent everywhere.
